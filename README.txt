...
For using sms-tools library you need to compile some C functions. For that you should go to the directory
``lib/sms-tools/models/utilFunctions_C`` and execution a python compilation script::
